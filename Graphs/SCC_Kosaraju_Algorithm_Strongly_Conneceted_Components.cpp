  ...
  void dfs(int curr,vector<vector<int>>&trans,vector<bool>&visited){
    ...
    int kosaraju(vector<vector<int>> &adj) {
       ...
       //make them false for future
        ...
        //keep track of number of stronglyconnectedcomponents
      //can use temp vector in dfs and store it in final vector of vector to find all SCCs
        int scc=0;
